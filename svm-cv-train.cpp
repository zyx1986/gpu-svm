//
// Created by zhengyuxin on 2/28/17.
//
...
int nr_fold = 5; // 5-fold cv by default
...
int main(int argc, char **argv)
{
    ...
    // do cv to get the best parameter
    std::pair<svm_parameter*, int> parameter_set = set_parameters(
            param,
            log_c_min, log_c_max, log_c_step,
            log_g_min, log_g_max, log_g_step);
